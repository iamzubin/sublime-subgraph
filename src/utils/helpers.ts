...
export function getLoanStatus(value: i32): string {
  switch (value) {
    case 0:
...
export function createUser(userAddress: Bytes): void {
...
export function setTwitterDetails(userAddress: Bytes, details: Bytes): void {
  let userId = userAddress.toHexString();
